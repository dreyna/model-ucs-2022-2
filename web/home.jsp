            ...
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    <a href="#" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                            ...
                            <a href="estudiantes.jsp" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fa-solid fa-user-group me-2"></i>Estudiantes</a>
                    ...
                    <div class="row g-3 my-2">
                        ...
                        <div class="col-md-3">
                            <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                                <div>
                                    ...
                                    <p class="fs-5">Matriculados</p>
                                </div>
                                <i
                                    class="fa-solid fa-solid fa-people-group fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                                <div>
                                    <h3 class="fs-2">20</h3>
                                    <p class="fs-5">Carreras</p>
                                </div>
                                <i class="fa-solid fa-building-columns fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                                <div>
                                    <h3 class="fs-2">80</h3>
                                    <p class="fs-5">Covenios</p>
                                </div>
                                <i class="fa-solid fa-handshake fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                            </div>
                        </div>
                    </div>
